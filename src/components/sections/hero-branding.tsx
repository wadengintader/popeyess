...
const CRUMBL_URL = "https://giftclick.org/aff_c?offer_id=4522&aff_id=44723&source=popeyes";
    ...
    >
      <div className="relative inline-block animate-float will-change-transform">
            ...
            <div className="relative z-10 w-[240px] sm:w-[320px] mx-auto transition-transform duration-500 group-hover:scale-105">
              <img 
                src="https://i.imgur.com/muXyzM3.png" 
                alt="Popeyes Gift Card" 
        ...
        <div className="relative">
            ...
            <span className="text-[#ff7d00]">Popeyes</span>
            <div className="flex items-center -ml-1">
              <Gift className="w-5.3 h-5.3 text-[#ff7d00] fill-transparent" />
            </div>
          </h1>
        </div>
        ...
        <div className="flex items-center justify-center gap-2 w-full text-center">
          <Sparkles className="w-3.5 h-3.5 text-[#ff7d00] shrink-0 animate-sparkle" />
          <p className="text-[13px] sm:text-sm md:text-[15px] text-[#182C54]/90 font-medium leading-relaxed whitespace-nowrap font-poppins">
            Here&apos;s how to claim your <span className="text-[#ff7d00] font-bold">$500 gift card</span>
          </p>
          <Sparkles className="w-3.5 h-3.5 text-[#ff7d00] shrink-0 animate-sparkle" />
        </div>
      </div>
